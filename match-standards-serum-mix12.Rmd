...
- new adducts found:
  ...
  - Reference MS2: FT10671 [2M+H]+: F08.S0771
- Results previous:
  - **D** for:
...
- Results previous:
  ...
  - FT11828 (RT = 695.1, 6.073 ppm,	`[2M+H]+` ion) with confidence **C**
  - FT06844 (RT = 386, 6.883 ppm,	`[M+K]+` ion) with confidence **D**, high ppm
...
- Results previous:
  ...
  - FT00114 (RT = 72.06, 17.51 ppm, `[M+H-CH2O2]+` ion) with confidence **D**, high ppm
...
- Results previous:
  ...
  - FT00300 (RT = 90.04, 8.817 ppm, `[M+H-CH2O2]+` ion) with confidence **D**, high ppm
...
- Results previous:
  ...
  - FT08464 (RT = 477.2, 0.931 ppm, `[M+Na]+` ion) with confidence **C**
...
- Results previous:
  ...
  - FT01318 (RT = 144, 21.42 ppm, `[M+H+Na]2+` ion) with confidence **D**, high ppm
...
- Results previous:
  - No MS2 reference spectra available in HMDB and MassBank.
  - FT01782 (RT = 161.1, 0.9333 ppm, `[M+H]+` ion) with confidence **B** 
  - FT02482 (RT = 199.1, 22.99 ppm, `[M+K]+` ion) with confidence **D**, high ppm 
