...
plot(cmps$exactmass, counts_df[, el])
...
depends on nX (number of atoms of type X in the molecule). We can determine two 
quantiles q1 and q2 such that a certain percentage (e.g 95%) of molecules in 
...
(e.g 95%) of molecules in HMBD have q1<P(observe mz)<q2.
