...
```{r, echo = FALSE}
fts <- data.frame(feature_id = c("FT00694", "FT01049", "FT00673"),
...
- Reference MS2: FT05055: F08.S0691 (>0.7), F07.S0699, F07.S0774
- labels: 
...
```{r, echo = FALSE}
fts <- data.frame(feature_id = c("FT05055", "FT04434", "FT03740", "FT01412", "FT06063", "FT03968", "FT06196", "FT05642"),
                  confidence_level = c("A", "C", "D", "D", "D", "D", "D", "D"))
## Get MS2 spectra:
ms2 <- std_ms2[match(c("FT05055_F08.S0691", "FT05055_F07.S0699", "FT05055_F07.S0774", 
                       "FT04434_F07.S0773", "FT04434_F07.S0697", "FT04434_F08.S0690"),
...
- Results previous:
  ...
  - other < D for, high rt dev: No for FT02069, is B label for Indoleacetic acid...
...
```{r, echo = FALSE}
fts <- data.frame(feature_id = c("FT01142", "FT01546", "FT03142", "FT04904"),
                  confidence_level = c("B", "B", "D", "D"))
## Get MS2 spectra:
ms2 <- std_ms2[match(c("FT01142_F08.S0562", "FT01142_F07.S0548", 
...
```{r, echo = FALSE}
fts <- data.frame(feature_id = c("FT02069", "FT00980", 'FT02506', 'FT02427'),
                  confidence_level = c("B", "D", 'D', 'D'))
## Get MS2 spectra:
...
```{r, echo = FALSE}
fts <- data.frame(feature_id = c("FT01854", "FT00866", "FT01858", "FT05847", "FT01499", "FT01519", "FT02414", "FT02750"),
                  confidence_level = c("C", "C", "C", "D", "D", "D", "D", "D"))
## Get MS2 spectra:
ms2 <- std_ms2[match(c("FT01854_F07.S0708", "FT01854_F07.S0770", "FT01854_F08.S0741", "FT01854_F08.S0683", 
                       "FT00866_F07.S0721", "FT00866_F08.S0711", 
                       'FT01858_F08.S0683'),
                     spectraNames(std_ms2))]
...
```{r, echo = FALSE}
fts <- data.frame(feature_id = c("FT04843", "FT05546"),
...
```{r, echo = FALSE}
fts <- data.frame(feature_id = c("FT02951", "FT02573", "FT02239", "FT03323", "FT03601", "FT04520"),
                  confidence_level = c("B", "C", "C", "D", "D", "D"))
## Get MS2 spectra:
ms2 <- std_ms2[match(c("FT02951_F07.S0144", "FT02951_F07.S0212", "FT02951_F08.S0148", "FT02951_F08.S0213", 
                       "FT02573_F08.S0170", "FT02573_F08.S0234", "FT02573_F07.S0171", 
                       'FT02239_F08.S0200', 'FT02239_F07.S0170'),
                     spectraNames(std_ms2))]
...
```{r, echo = FALSE}
fts <- data.frame(feature_id = c("FT01770", "FT02209", "FT03085", "FT02682", "FT01378"),
...
```{r, echo = FALSE}
fts <- data.frame(feature_id = c("FT02624", "FT02623", "FT00474", "FT02309", "FT02308", "FT00473"),
                  confidence_level = c("B", "B", "D", "D", "D", "D"))
## Get MS2 spectra:
ms2 <- std_ms2[match(c("FT02624_F07.S0800", "FT02624_F07.S0832", "FT02624_F08.S0782", 
                       "FT02623_F07.S0800", "FT02623_F07.S0832", "FT02623_F07.S0171"),
                     spectraNames(std_ms2))]
ms2$confidence <- c('high', 'high', 'high',
                    'high', 'high', 'high')
```
...
```{r, echo = FALSE}
fts <- data.frame(feature_id = c("FT05365", "FT04196"),
                  confidence_level = c("D", 'D'))
```
...
```{r, echo = FALSE}
fts <- data.frame(feature_id = c("FT0586'),
                  confidence_level = c("D")
```
...
```{r, echo = FALSE}
fts <- data.frame(feature_id = c("FT0290"),
                  confidence_level = c("D"))
```
...
```{r, echo = FALSE}
fts <- data.frame(feature_id = c("FT1445", "FT2045", 'FT1883', 'FT2434'),
                  confidence_level = c("B", "B", 'D', 'D'))
## Get MS2 spectra:
ms2 <- std_ms2[match(c("FT1445_F15.S0303", "FT1445_F16.S0304",
                       "FT2045_F15.S0305", 'FT2045_F16.S0305'),
                     spectraNames(std_ms2))]
ms2$confidence <- c('high', 'high',
                    'high', 'high')
```
