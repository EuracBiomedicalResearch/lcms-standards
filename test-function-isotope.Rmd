...
iso_gr_dime <- .isotope_peaks(pm_dime, substDefinition = subst_def, 
                              seedMz = mz_dime, ppm = 20)
iso_gr_lglu <- .isotope_peaks(pm_lglu, substDefinition = subst_def, 
                              seedMz = mz_lglu, ppm = 20)
iso_gr_myo <- .isotope_peaks(pm_myo, substDefinition = subst_def, 
                              seedMz = mz_myo, ppm = 20)
iso_gr_phos <- .isotope_peaks(pm_phos, substDefinition = subst_def, 
                              seedMz = mz_phos, ppm = 20)
iso_gr_sub <- .isotope_peaks(pm_sub, substDefinition = subst_def, 
