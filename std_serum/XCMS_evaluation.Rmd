...
proc <- "postproces" # specify "default" or "postprocessing"
mz.d <- 0.01
rt.d <- 10
dir.create(paste0("images/", study, "/", polarity, "/default"), 
                  recursive = TRUE, showWarnings = FALSE)
dir.create(paste0("images/", study, "/", polarity, "/postproces"), 
                  recursive = TRUE, showWarnings = FALSE)
```
...
} else if (proc == "postproces"){
  load(paste0("XCMS_postprocessing_", polarity, "_", study, ".Rdata"))
}
...
for(i in seq(nrow(std_info))){ # for each IS do the following:
  ...
  filename <- paste0("images/", study, "/", polarity, "/", proc, "/",
