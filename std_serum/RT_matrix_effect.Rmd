...
The data used is from the experiment done on 18-Nov-2019 by Vinicius Veri. Sample names are stored in the file [`is_serum_files.txt`](data/is_serum_files.txt) and experiment description in the file
