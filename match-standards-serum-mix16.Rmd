...
- EICs are not super clear. There seem to be co-eluting peaks or multi-peak
  signal.
  

```{r, echo = FALSE}
fts <- data.frame(feature_id = c("FT02687", "FT02053", "FT02361",
                                 "FT03367", "FT03073"),
                  confidence_level = c("B-", "B-", "B", "B-", "B-"))
## Get MS2 spectra:
ms2 <- std_ms2[match(c("FT02361_F07.S0595", "FT03492_F08.S0610",
                       "FT03073_F07.S0584", "FT03073_F08.S0580",
                       "FT03073_F08.S0619", "FT02360_F07.S0595"),
                     spectraNames(std_ms2))]
ms2$confidence <- c("high", rep("low", 5))
```
...
```{r, echo = FALSE}
fts <- data.frame(feature_id = c("FT01257", "FT01805", "FT02151",
                                 "FT02543", "FT02959"),
...
```{r, echo = FALSE}
fts <- data.frame(feature_id = c("FT02279", "FT01063"),
                  confidence_level = c("D"))
```
...
```{r, echo = FALSE}
fts <- data.frame(feature_id = c("FT01341", "FT01692"),
                  confidence_level = c("A-", "A"))
## Get MS2 spectra:
ms2 <- std_ms2[match(c("FT01341_F07.S0710", "FT01341_F08.S0718",
                       "FT01692_F07.S0712", "FT01692_F08.S0721"),
                     spectraNames(std_ms2))]
...
```{r, echo = FALSE}
fts <- data.frame(feature_id = c("FT1760", "FT1237", "FT1635"),
                  confidence_level = c("C-", "C", "C-"))
## Get MS2 spectra:
ms2 <- std_ms2[match(c("FT1762_F15.S0510", "FT1237_F15.S0509",
                       "FT1635_F16.S0517"),
                     spectraNames(std_ms2))]
...
```{r, echo = FALSE}
fts <- data.frame(feature_id = c("FT1421", "FT0834", "FT3652"),
                  confidence_level = c("C-", "C", "C-"))
## Get MS2 spectra:
ms2 <- std_ms2[match(c("FT0837_F15.S0157", "FT0837_F16.S0165"),
                     spectraNames(std_ms2))]
ms2$confidence <- c("low")
```
...
```{r, echo = FALSE}
fts <- data.frame(feature_id = c("FT0564", "FT1429", "FT2989"),
                  confidence_level = c("D"))
## Get MS2 spectra:
ms2 <- std_ms2[match(c("FT0564_F15.S0790", "FT0564_F15.S0838",
                       "FT0564_F16.S0758", "FT0564_F16.S0796",
                       "FT2989_F15.S0809"),
                     spectraNames(std_ms2))]
ms2$confidence <- c("low")
```
...
## Get MS2 spectra:
ms2 <- std_ms2[match(c("FT0918_F15.S0370", "FT0918_F16.S0293",
                       "FT0918_F16.S0322", "FT3856_F15.S0377"),
                     spectraNames(std_ms2))]
ms2$confidence <- c("high")
```
...
```{r, echo = FALSE}
fts <- data.frame(feature_id = c("FT3373", "FT1317", "FT0723"),
                  confidence_level = c("D"))
```
...
## Get MS2 spectra:
ms2 <- std_ms2[match(c("FT1899_F15.S0888", "FT1899_F15.S0900",
                       "FT1899_F16.S0861"),
                     spectraNames(std_ms2))]
ms2$confidence <- c("high")
```
...
```{r, echo = FALSE}
fts <- data.frame(feature_id = c("FT0531"),
                  confidence_level = c("B"))
## Get MS2 spectra:
ms2 <- std_ms2[match(c("FT0531_F16.S0608"),
                     spectraNames(std_ms2))]
ms2$confidence <- c("low")
```
