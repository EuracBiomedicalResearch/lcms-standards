...
```{r, echo = FALSE}
fts <- data.frame(feature_id = c("FT02361", "FT02150", 'FT01257', 'FT01805'),
...
- Reference MS2: FT0918: F15.S0370
- Reference MS2: FT3856: F16.S0293, F16.S0322, F15.S0377

```{r, echo = FALSE}
fts <- data.frame(feature_id = c("FT0918", 'FT3856'),
                  confidence_level = c("B", "B"))
## Get MS2 spectra:
ms2 <- std_ms2[match(c("FT0918_F15.S0370",
                       "FT3856_F16.S0293", "FT3856_F16.S0322", "FT3856_F15.S0377"),
                     spectraNames(std_ms2))]
ms2$confidence <- c("high", 
                    'high', 'high', 'low')
```
