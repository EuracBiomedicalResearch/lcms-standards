...
#if(mix < 10){
#  dir.create(paste0("images/MIX0", mix, "/", polarity, "/exclusion"), 
#                  recursive = TRUE, showWarnings = FALSE)
#} else {
#  dir.create(paste0("images/MIX", mix, "/", polarity, "/exclusion"), 
#                  recursive = TRUE, showWarnings = FALSE)
#}
```
...
ih_exclusion <- read.table(gsub("MIX", "data/inhouse_exclusion.txt", getwd()),
...
for(i in seq(length(idx))){
  ...
  filename <- paste0("images/", 
                     ...
                     "/", polarity, "/exclusion/", cmpname, "_FT.png")
