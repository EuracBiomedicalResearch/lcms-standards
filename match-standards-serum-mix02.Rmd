...
```{r mix02-serum-pos-lactic-acid-ms2, echo = FALSE}
plot_spectra(std_ms2)
```
...
```{r mix02-serum-pos-udp-glucuronate-ms2, echo = FALSE}
plot_spectra(std_ms2)
```
...
```{r mix02-serum-neg-lactic-acid-ms2, echo = FALSE}
plot_spectra(std_ms2)
```
...
```{r mix02-serum-neg-udp-glucuronate-ms2, echo = FALSE}
plot_spectra(std_ms2)
```
