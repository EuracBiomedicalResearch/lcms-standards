...
We subset the data according to matrix (and polarity) considering MS1 data only
(i.e. excluding the data files generated by LC-MS/MS).
...
```{r volcano-water-pos, fig.path = IMAGE_PATH, fig.width = 6, fig.height = 6, fig.cap = "Volcano plot representing the signifcant features for the comparison of high vs low concentration in water, positive polarity."}
...
```{r volcano-water-neg, fig.path = IMAGE_PATH, fig.width = 6, fig.height = 6, fig.cap = "Volcano plot representing the signifcant features for the comparison of high vs low concentration in water, negative polarity."}
...
```{r volcano-serum-pos, fig.path = IMAGE_PATH, fig.width = 6, fig.height = 6, fig.cap = "Volcano plot representing the signifcant features for the comparison of high vs low concentration in serum, positive polarity."}
...
```{r volcano-serum-neg, fig.path = IMAGE_PATH, fig.width = 6, fig.height = 6, fig.cap = "Volcano plot representing the signifcant features for the comparison of high vs low concentration in serum, negative polarity."}
