...
- Reference MS2: `[M+H+]`: FT1809_F07.S0202, FT1809_F07.S0227, FT1809_F08.S0205;
  high confidence. `[M+H-H2O]+`: FT1475_F07.S0196, FT1475_F07.S0220,
  FT1475_F08.S0193, FT1475_F08.S0211; high confidence.

```{r, echo = FALSE}
## Define the feature (ion) and MS2 spectra to insert
fts <- data.frame(feature_id = c("FT1809", "FT1475"),
                  confidence_level = c("A", "A-"))

## Get MS2 spectra:
ms2 <- std_ms2[c("FT1809_F07.S0202", "FT1809_F07.S0227", "FT1809_F08.S0205",
                 "FT1475_F07.S0196", "FT1475_F07.S0220", "FT1475_F08.S0193",
                 "FT1475_F08.S0211")]
...
- The MS2 spectra don't seem to match acetylglicine (but glycine
  instead). Still, assigning the feature with confidence level **C** because the
  EIC looks OK.
...
```{r, echo = FALSE}
## Define the feature (ion) and MS2 spectra to insert
fts <- data.frame(feature_id = c("FT0634", "FT0314"),
                  confidence_level = c("C", "C-"))

## Get MS2 spectra:
ms2 <- std_ms2[c("FT0634_F08.S0158")]
...
- Assigning grade *A* although it can not distinguish between Arginine,
  L-Arginine and DL-Arginine. Argamine seems not to be a correct chemical name.
- There is a second, large peak at around 211 seconds (with matching MS2
  spectra), but we assign the first feature.
- FT1523 (RT = 188.3, `[M+H]+` ion) with confidence **A**.
- FT1879 (RT = 188.6, `[M+Na]+` ion) with confidence **A-**.
- FT0170 (RT = 188.5, `[M+2H]2+` ion) with confidence **A-**.
- FT1218 (RT = 188.6, `[M+H-H2O]+` ion) with confidence **A-**.
- FT1231 (RT = 188.1, `[M+H-NH3]+` ion) with confidence **A-**.
- Reference MS2: `[M+H]+`: FT1523_F07.S0577, FT1523_F07.S0609, FT1523_F08.S0582,
  FT1523_F08.S0619; high confidence. `[M+H-H2O]+`: FT1218_F07.S0592,
  FT1218_F08.S0590; low confidence. `[M+H-NH3]+`: FT1231_F07.S0575; low
  confidence. FT1231_F08.S0580; high confidence.

```{r, echo = FALSE}
## Define the feature (ion) and MS2 spectra to insert
fts <- data.frame(feature_id = c("FT1523", "FT1879", "FT0170", "FT1218",
                                 "FT1231"),
                  confidence_level = c("A", "A-", "A-", "A-", "A-"))

## Get MS2 spectra:
ms2 <- std_ms2[c("FT1523_F07.S0577", "FT1523_F07.S0609", "FT1523_F08.S0582",
                 "FT1523_F08.S0619", "FT1231_F08.S0580", "FT1218_F07.S0592",
                 "FT1218_F08.S0590", "FT1231_F07.S0575")]
...
- Using grade *A* although MS2 spectra match also MS2 spectra from Proline, but
  with a larger difference of their precursor.
- FT0812 (RT = 185, `[M+H]+` ion) with confidence **A**.
- FT1182 (RT = 184.7, `[M+Na]+` ion) with confidence **A-**.
- FT1453 (RT = 184.7, `[M+K]+` ion) with confidence **A-**.
- FT0596 (RT = 184.5, `[M+H-NH3]+` ion) with confidence **A-**.
- (Eventually) FT0584 (RT = 184.8, `[M+H-H2O]+` ion) with confidence **A-**.
- Reference MS2: `[M+H]+`: FT0812_F07.S0556, FT0812_F08.S0564; high
  confidence. `[M+Na]+`: FT1182_F08.S0565; low confidence. `[M+H-NH3]+`:
  FT0596_F08.S0561, FT0596_F07.S0574; low confidence.

```{r, echo = FALSE}
## Define the feature (ion) and MS2 spectra to insert
fts <- data.frame(feature_id = c("FT0812", "FT1182", "FT1453", "FT0596"),
                  confidence_level = c("A", "A-", "A-", "A-"))

## Get MS2 spectra:
ms2 <- std_ms2[c("FT0812_F07.S0556", "FT0812_F08.S0564", "FT1182_F08.S0565",
                 "FT0596_F08.S0561", "FT0596_F07.S0574")]
...
- Signal for Choline is very high and a very broad peak is present. For
  representative feature we select the first one.
- FT0364 (RT = 36.68, ion `[M+H]+`): confidence **A**.
- FT0158 (RT = 33.94, ion `[M+H-H2O]+`): confidence **A-**.
- Reference MS2: `[M+H]+`: FT0364_F08.S0122, FT0362_F07.S0121; high confidence.

```{r, echo = FALSE}
## Get MS2 spectra:
ms2 <- std_ms2[c("FT0364_F08.S0122", "FT0362_F07.S0121")]
ms2$confidence <- c("high")
```
...
- FT3264 (RT=209.8, `[M+H]+` ion) confidence level **A**.
...
- Reference MS2: `[M+H]+`: FT3264_F07.S0677, FT3264_F07.S0715, FT3264_F08.S0676;
  high confidence. `[M+Na]+`: FT3570_F07.S0678, FT3570_F08.S0689; low
  confidence. `[M+K]+`: FT3727_F07.S0679, FT3727_F08.S0691; low confidence.

```{r, echo = FALSE}
## Define the feature (ion) and MS2 spectra to insert
fts <- data.frame(feature_id = c("FT3264", "FT3570", "FT3727", "FT3060"),
                  confidence_level = c("A", "A-", "A-", "A-"))

## Get MS2 spectra:
ms2 <- std_ms2[c("FT3264_F07.S0677", "FT3264_F07.S0715", "FT3264_F08.S0676",
                 "FT3570_F07.S0678", "FT3570_F08.S0689", "FT3727_F07.S0679",
                 "FT3727_F08.S0691")]
...
- We assign grade *A* although we can not distinguish Cysting and L-Cystine.
- FT2332 (RT = 211, `[M+H]+`): confidence level **A**.
- FT0671 (RT = 210.9 `[M+2H]2+`): confidence level **A-**.
- Reference MS2: `[M+H]+`: FT2332_F07.S0673, FT2332_F07.S0714, FT2332_F08.S0687,
  FT2332_F08.S0718; high confidence.

```{r, echo = FALSE}
## Get MS2 spectra:
ms2 <- std_ms2[c("FT2332_F07.S0673", "FT2332_F07.S0714", "FT2332_F08.S0687",
                 "FT2332_F08.S0718")]
ms2$confidence <- c("high")
```
...
- Note that we're also adding the `[M+Na]+` feature although its MS2 spectra
  match MS2 spectra from other compounds, that are however not included in this
  mix. Also, the EIC looks similar to the one of the `[M+H]+` ion.
- FT0512 (RT = 173.5, ion `[M+H]+`): confidence level **A**.
- FT0835 (RT = 171.6, ion `[M+Na]+`): confidence level **A-**.
- FT0259 (RT = 173.2, ion `[M+H-NH3]+`): confidence level **A-**.
- Reference MS2: `[M+H]+`: FT0512_F07.S0515, FT0512_F07.S0553, FT0512_F08.S0512;
  high confidence. `[M+Na]+`: FT0835_F07.S0516, FT0835_F08.S0504; low
  confidence. `[M+H-NH2]+`: FT0259_F07.S0514, FT0259_F08.S0511; low confidence.

```{r, echo = FALSE}
## Define the feature (ion) and MS2 spectra to insert
fts <- data.frame(feature_id = c("FT0512", "FT0835", "FT0259"),
                  confidence_level = c("A", "A-", "A-"))

## Get MS2 spectra:
ms2 <- std_ms2[c("FT0512_F07.S0515", "FT0512_F07.S0553", "FT0512_F08.S0512",
                 "FT0835_F07.S0516", "FT0835_F08.S0504", "FT0259_F07.S0514",
                 "FT0259_F08.S0511")]
ms2$confidence <- c(rep("high", 3), rep("low", 4))
```
...
- No reference spectra in HMDB or MassBank for `r std`. There is however only a
  single feature measured.
- FT0162 (RT = 32.83, `[M+H-H2O]+` ion) confidence level **D**.
- Reference MS2: `[M+H-H2O]+`: FT0162_F07.S0110, FT0162_F08.S0111; low
  confidence.

```{r, echo = FALSE}
## Define the feature (ion) and MS2 spectra to insert
fts <- data.frame(feature_id = c("FT0162"),
                  confidence_level = c("D"))

## Get MS2 spectra:
ms2 <- std_ms2[c("FT0162_F07.S0110", "FT0162_F08.S0111")]
ms2$confidence <- c("low")
```
...
Matches are OKish with some additional peaks almost matching.
...
- While MS2 spectra don't match well, EICs show a very nice, clean signal.
...
- Reference MS2: `[M+H]+`: FT1327_F07.S0550, FT1327_F08.S0551; low
  confidence. `[M+Na]+`: FT1782_F08.S0538; low confidence. `[M+H-NH3]+`:
  FT1083_F08.S0549; low confidence.

```{r, echo = FALSE}
## Define the feature (ion) and MS2 spectra to insert
fts <- data.frame(feature_id = c("FT1327", "FT1782", "FT2028",
                                 "FT1062", "FT1083"),
                  confidence_level = c("C", "C-", "C-", "C-", "C-"))

## Get MS2 spectra:
ms2 <- std_ms2[c("FT1327_F07.S0550", "FT1327_F08.S0551", "FT1782_F08.S0538",
                 "FT1083_F08.S0549")]
ms2$confidence <- c("low")
```
...
- Inconclusive. Need to check negative polarity and serum data. Best candidates
  are listed below. From these, the first at a retention time of 36 seconds
  seems more likely, because paracetamol is less water soluble and is thus
  expected to elute earlier.
- FT1504 (RT = 36.6, `[M+Na]+` ion) with confidence level **D**.
- FT1807 (RT = 183, `[M+K]+` ion) with confidence level **D**.
...
- The signal for this compound is very broad resulting in many features across a
  wide RT range. For ions with multiple features we select the on with the
  *best* EIC.
...
- Reference MS2: `[M+H]+`: FT3947_F07.S0396, FT3947_F07.S0466, FT3947_F08.S0390,
  FT3947_F08.S0464; high confidence. `[M+Na]+`: FT4190_F07.S0386,
  FT4190_F07.S0440, FT4190_F08.S0379, FT4190_F08.S0452; low
  confidence. `[M+K]+`: FT4355_F07.S0399, FT4355_F08.S0411; low
  confidence. `[M+2Na-H]+`: FT4409_F07.S0387, FT4409_F07.S0441,
  FT4409_F08.S0380, FT4409_F08.S0434; low confidence. `[M+H-H2O]+`:
  FT3732_F07.S0395, FT3732_F08.S0366, FT3732_F08.S0445; low confidence.

```{r, echo = FALSE}
## Define the feature (ion) and MS2 spectra to insert
fts <- data.frame(feature_id = c("FT3947", "FT4190", "FT4355",
                                 "FT4409", "FT3732"),
                  confidence_level = c("A", "C", "A-", "C-", "A-"))

## Get MS2 spectra:
ms2 <- std_ms2[c("FT3947_F07.S0396", "FT3947_F07.S0466", "FT3947_F08.S0390",
                 "FT3947_F08.S0464", "FT4190_F07.S0386", "FT4190_F07.S0440",
                 "FT4190_F08.S0379", "FT4190_F08.S0452", "FT4355_F07.S0399",
                 "FT4355_F08.S0411", "FT4409_F07.S0387", "FT4409_F07.S0441",
                 "FT4409_F08.S0380", "FT4409_F08.S0434", "FT3732_F07.S0395",
                 "FT3732_F08.S0366", "FT3732_F08.S0445")]
...
- Inconclusive; needs verification with negative polarity and serum data. From
  the EIC signal FT1475 (`[M+2H]2+`; RT = 87) seems the best candidate. From the
  MS2 spectra maybe the `[M+Na]+` ions.
...
- FT2214 (RT= 154.1, `[M+Na]+` ion) with confidence level **A-**.
- FT2361 (RT= 154.6, `[M+K]+` ion) with confidence level **A-**.
...
- Reference MS2: `[M+H]+`: FT1965_F08.S0425, FT1965_F07.S0412, FT1965_F07.S0479;
  high confidence. `[M+Na]+`: FT2214_F07.S0438; low confidence. `[M+2Na-H]+`:
  FT2427_F08.S0426; low confidence. `[M+H-NH3]+`: FT1784_F07.S0411,
  FT1784_F07.S0478, FT1784_F08.S0424; low confidence.

```{r, echo = FALSE}
## Define the feature (ion) and MS2 spectra to insert
fts <- data.frame(feature_id = c("FT1965", "FT2214", "FT2361",
                                 "FT2427", "FT1784"),
                  confidence_level = c("A", "A-", "A-", "A-", "A-"))

## Get MS2 spectra:
ms2 <- std_ms2[c("FT1965_F08.S0425", "FT1965_F07.S0412", "FT1965_F07.S0479",
                 "FT2214_F07.S0438", "FT2427_F08.S0426", "FT1784_F07.S0411",
                 "FT1784_F07.S0478", "FT1784_F08.S0424")]
ms2$confidence <- c(rep("high", 3), rep("low", 5))
```
...
- Reference MS2: `[M+H]+`: FT5731_F07.S0870, FT5731_F08.S0877; high
  confidence. `[M+K]+`: FT5874_F08.S0878; low confidence.

```{r, echo = FALSE}
## Define the feature (ion) and MS2 spectra to insert
fts <- data.frame(feature_id = c("FT5731", "FT5874"),
                  confidence_level = c("A", "A-"))

## Get MS2 spectra:
ms2 <- std_ms2[c("FT5731_F07.S0870", "FT5731_F08.S0877", "FT5874_F08.S0878")]
...
```{r, echo = FALSE}
## Define the feature (ion) and MS2 spectra to insert
fts <- data.frame(feature_id = c("FT0483"),
                  confidence_level = c("A"))

## Get MS2 spectra:
ms2 <- std_ms2[c("FT0483_F15.S0185", "FT0483_F15.S0206", "FT0483_F16.S0182")]
...
```{r, echo = FALSE}
## Define the feature (ion) and MS2 spectra to insert
fts <- data.frame(feature_id = c("FT0098", "FT0342"),
                  confidence_level = c("A", "A-"))

## Get MS2 spectra:
ms2 <- std_ms2[c("FT0098_F15.S0141", "FT0098_F15.S0171", "FT0098_F16.S0134")]
ms2$confidence <- c("high")
```
...
- FT0397 (RT = 187.8 with, `[M-H]-` ion) with confidence level **A**.
- FT0690 (RT = 187.8 with, `[M+HCOO]-` ion) with confidence level **A-**.
- Reference MS2: `[M-H]-`: FT0397_F15.S0527, FT0397_F15.S0575, FT0397_F16.S0538;
  high confidence.

```{r, echo = FALSE}
## Define the feature (ion) and MS2 spectra to insert
fts <- data.frame(feature_id = c("FT0397", "FT0690"),
                  confidence_level = c("A", "A-"))

## Get MS2 spectra:
ms2 <- std_ms2[c("FT0397_F15.S0527", "FT0397_F15.S0575", "FT0397_F16.S0538")]
ms2$confidence <- c("high")
```
...
- FT0363 (RT = 184.4, `[M+Cl]-` ion) with confidence level **C-**.
- Reference MS2: `[M-H-]`: FT0165_F15.S0516, FT0165_F16.S0460; low confidence.

```{r, echo = FALSE}
## Define the feature (ion) and MS2 spectra to insert
fts <- data.frame(feature_id = c("FT0165", "FT0363"),
                  confidence_level = c("C", "C-"))

## Get MS2 spectra:
ms2 <- std_ms2[c("FT0165_F15.S0516", "FT0165_F16.S0460")]
ms2$confidence <- c("low")
```
...
- Inconclusive; need to check/evaluate positive polarity and serum data.
- (Eventually) FT0228 (RT=115, `[M+Cl]-` ion) with confidence **D**??
...
- Reference MS2: `[M-H]-`: FT1430_F15.S0629, FT1430_F15.S0677, FT1430_F15.S0707,
  FT1430_F16.S0586, FT1430_F16.S0665; high confidence.

```{r, echo = FALSE}
## Define the feature (ion) and MS2 spectra to insert
fts <- data.frame(feature_id = c("FT1430", "FT1810"),
                  confidence_level = c("A", "A-"))

## Get MS2 spectra:
ms2 <- std_ms2[c("FT1430_F15.S0629", "FT1430_F15.S0677", "FT1430_F15.S0707",
                 "FT1430_F16.S0586", "FT1430_F16.S0665")]
ms2$confidence <- c("high")
```
...
## Get MS2 spectra:
ms2 <- std_ms2[c("FT0793_F15.S0647", "FT0793_F15.S0680", "FT0793_F15.S0722",
                 "FT0793_F16.S0596", "FT0793_F16.S0635", "FT0793_F16.S0663")]
ms2$confidence <- c("high")
```
...
- Inconclusive; need to evaluate positive polarity and serum data. EIC signal is
  very low.
- FT0060 (RT = 172.6, `[M-H]-` ion) with confidence level **C**.
- FT0319 (RT = 172.6, `[M+HCOO]-` ion) with confidence level **C-**.

```{r, echo = FALSE}
## Define the feature (ion) and MS2 spectra to insert
fts <- data.frame(feature_id = c("FT0060", "FT0319"),
                  confidence_level = c("C", "C-"))

## Get MS2 spectra:
ms2 <- std_ms2[c("FT0060_F15.S0469")]
ms2$confidence <- c("low")
```
...
- Inconclusive; needs evidence from positive polarity or serum data. EIC of
  FT0052 looks however nice.
- FT0052 (RT = 37.6, `[M-H]-` ion) with confidence level **D**.
- Reference MS2: `[M-H]-`: FT0052_F15.S0103, FT0052_F16.S0093; low confidence.

```{r, echo = FALSE}
## Get MS2 spectra:
ms2 <- std_ms2[c("FT0052_F15.S0103", "FT0052_F16.S0093")]
ms2$confidence <- c("low")
```
...
- Inconclusive; needs evidence from positive polarity or serum data.
- FT0354 (RT = 182.9, `[M-H]-` ion) with confidence level **D**.
- FT0640 (RT = 192.6, `[M+HCOO]-` ion) with confidence level **D**.
- Reference MS2: `[M-H]-`: FT0354_F15.S0495, FT0354_F16.S0462; low confidence.

```{r, echo = FALSE}
## Get MS2 spectra:
ms2 <- std_ms2[c("FT0354_F15.S0495", "FT0354_F16.S0462")]
ms2$confidence <- c("low")
```
...
- Reference MS2: `[M-H]-`: FT0292_F15.S0105, FT0292_F16.S0095; high confidence.

```{r, echo = FALSE}
## Define the feature (ion) and MS2 spectra to insert
fts <- data.frame(feature_id = c("FT0292", "FT0543"),
                  confidence_level = c("A", "A-"))

## Get MS2 spectra:
ms2 <- std_ms2[c("FT0292_F15.S0105", "FT0292_F16.S0095")]
ms2$confidence <- c("high")
```
...
- Selected features have a highly similar EIC shape then in positive polarity.
- FT1877 (RT = 146, `[M-H]-` ion) with confidence level **D**.
- FT2243 (RT = 146.2, `[M+HCOO]-` ion) with confidence level **D**.
- Reference MS2: `[M-H]-`: FT1877_F15.S0332, FT1877_F15.S0384, FT1877_F16.S0318,
  FT1877_F16.S0366; low confidence.

```{r, echo = FALSE}
## Define the feature (ion) and MS2 spectra to insert
fts <- data.frame(feature_id = c("FT1877", "FT2243"),
                  confidence_level = c("D", "D"))

## Get MS2 spectra:
ms2 <- std_ms2[c("FT1877_F15.S0332", "FT1877_F15.S0384", "FT1877_F16.S0318",
                 "FT1877_F16.S0366")]
ms2$confidence <- c("low")
```
...
- MS2 spectra:`[M-H]-`: FT1643_F15.S0528, FT1643_F16.S0494; high confidence.
  `[M+HCOO]-`: FT1971_F15.S0531, FT1971_F16.S0497; high confidence.

```{r, echo = FALSE}
## Define the feature (ion) and MS2 spectra to insert
fts <- data.frame(feature_id = c("FT1643", "FT1971"),
                  confidence_level = c("B", "B"))

## Get MS2 spectra:
ms2 <- std_ms2[c("FT1643_F15.S0528", "FT1643_F16.S0494", "FT1971_F15.S0531",
                 "FT1971_F16.S0497")]
ms2$confidence <- c("high")
```
...
- FT0600 (RT = 151.1, `[M-H]-` ion) confidence **A**.
- FT0852 (RT = 151.3, `[M+HCOO]-` ion) confidence **A-**.
- Reference MS2: `[M-H]-`: FT0600_F15.S0399, FT0600_F16.S0380; high confidence.

```{r, echo = FALSE}
## Define the feature (ion) and MS2 spectra to insert
fts <- data.frame(feature_id = c("FT0600", "FT0852"),
                  confidence_level = c("A", "A-"))

## Get MS2 spectra:
ms2 <- std_ms2[c("FT0600_F15.S0399", "FT0600_F16.S0380")]
ms2$confidence <- c("high")
```
...
- Reference MS2: `[M-H]-`: FT3283_F16.S0787; high confidence.

```{r, echo = FALSE}
## Define the feature (ion) and MS2 spectra to insert
fts <- data.frame(feature_id = c("FT3283"),
                  confidence_level = c("A"))

## Get MS2 spectra:
ms2 <- std_ms2[c("FT3283_F16.S0787")]
ms2$confidence <- c("high")
```
