...
```{r, echo = FALSE}
fts <- data.frame(feature_id = c("FT01064", "FT00763"),
                  confidence_level = c("B", "D"))
## Get MS2 spectra:
ms2 <- std_ms2[match(c("FT01064_F08.S0417", "FT01064_F07.S0427"),
...
## Get MS2 spectra:
ms2 <- std_ms2[match(c("FT04738_F08.S0740", "FT04738_F08.S0793", "FT04738_F07.S0765", "FT04738_F07.S0806", "FT04738_F07.S0834",
                       'FT09502_F08.S0746'),
                     spectraNames(std_ms2))]
ms2$confidence <- c("low", 'high', 'low', 'low', 'low',
                    "high")
```
...
```{r, echo = FALSE}
fts <- data.frame(feature_id = c("FT0283", "FT0703"),
                  confidence_level = c("B", "D"))
## Get MS2 spectra:
...
```{r, echo = FALSE}
fts <- data.frame(feature_id = c("FT2528", "FT6303"),
                  confidence_level = c("B", "D"))
## Get MS2 spectra:
ms2 <- std_ms2[match(c("FT2528_F16.S0655", "FT2528_F15.S0629", "FT2528_F15.S0676", "FT2528_F15.S0699", "FT2528_F16.S0701"),
                     spectraNames(std_ms2))]
ms2$confidence <- c("high", 'high', "high", "high", "high")
```
