...
cmp <- data.frame(compound_id = "725436",     #PubChem CID
...
fts$compound_id <- std_dilution$HMDB[std_dilution$name == std] #becomes NA
...
cmp <- data.frame(compound_id = "79496",     #PubChem CID
...
cmp <- data.frame(compound_id = "23017",     #PubChem CID
