...
```
```{r mix04-serum-pos-gamma-aminobutyric-acid-mirror-hmdb_nl, echo = TRUE, fig.cap = "Mirror plots"}
...
```{r mix04-serum-pos-gamma-aminobutyric-acid-mirror-mbank_nl, echo = TRUE, fig.cap = "Mirror plots"}
...
- FT01561 (RT = 69.2, `[M+Na]+` ion) confidence level **C**?
- MS2 spectra: FT01561_F07.S0268, FT01561_F08.S0326.
...
```{r mix04-serum-pos-allantoin-ms2-mbank_nl, echo = FALSE, fig.width = 5, fig.height = 5}
std_mbank_nl <- get_mbank(mbank, inchikey = unique(std_hmdb$inchikey), nl = TRUE)
std_ms2_nl <- neutralLoss(std_ms2, nl_param)
sim <- plot_ms2_similarity_heatmap(std_ms2_nl, std_mbank_nl, csp_nl)
```

```{r mix04-serum-pos-ascorbic-butyrylcarnitine-mirror-hmdb, echo = TRUE, fig.cap = "Mirror plots"}
...
- FT02105 (RT = 107, `[M+Na]+` ion) confidence level **C**.
- Reference MS2: `[M+H+]`: FT01672_F07.S0500, FT01672_F08.S0529; low confidence.
  ...
  `[M+Na]+`: FT02105_F07.S0417; low confidence.
...
```{r mix04-serum-pos-gamma-aminobutyric-acid-ms2-hmdb_nl, echo = FALSE, fig.width = 5, fig.height = 5}
std_hmdb_nl <- hmdb_nl[hmdb_nl$compound_id == hmdb_id]
std_ms2_nl <- neutralLoss(std_ms2, nl_param)
sim <- plot_ms2_similarity_heatmap(std_ms2_nl, std_hmdb_nl, csp_nl)
```

```{r mix04-serum-pos-gamma-aminobutyric-acid-ms2-mbank_nl, echo = FALSE, fig.width = 5, fig.height = 5}
std_mbank_nl <- get_mbank(mbank, inchikey = unique(std_hmdb$inchikey), nl = TRUE)
std_ms2_nl <- neutralLoss(std_ms2, nl_param)
sim <- plot_ms2_similarity_heatmap(std_ms2_nl, std_mbank_nl, csp_nl)
```
...
- Reference MS2: `[M+H]+`: FT00542_F07.S0545, FT00542_F07.S0634,
  FT00542_F08.S0579; low confidence.
  `[M+H-NH3]+`: FT00312_F08.S0578
  `[M+H-H2O]+`: FT00302_F08.S0557
...
```{r mix04-serum-pos-amp-ms2-hmdb_nl, echo = FALSE, fig.width = 5, fig.height = 5}
std_hmdb_nl <- hmdb_nl[hmdb_nl$compound_id == hmdb_id]
std_ms2_nl <- neutralLoss(std_ms2, nl_param)
sim <- plot_ms2_similarity_heatmap(std_ms2_nl, std_hmdb_nl, csp_nl)
```

```{r mix04-serum-pos-amp-ms2-mbank_nl, echo = FALSE, fig.width = 5, fig.height = 5}
std_mbank_nl <- get_mbank(mbank, inchikey = unique(std_hmdb$inchikey), nl = TRUE)
std_ms2_nl <- neutralLoss(std_ms2, nl_param)
sim <- plot_ms2_similarity_heatmap(std_ms2_nl, std_mbank_nl, csp_nl)
```
...
Are Adenosine monophosphate, 3'-AMP, Adenosine 5'-monophosphate, AMP the same?
If so below it is confidence **A**.

- FT06197 (RT = 212, `[M+H]+` ion) with confidence **B**.
- FT06779 (RT = 211.3, `[M+Na]+` ion) with confidence **B-**.
- FT07164 (RT = 211.8, `[M+K]+` ion) with confidence **B-**.
- FT06198 (RT = 231.4, `[M+H]+` ion) with confidence **B**.
- FT07319 (RT = 228.2, `[M+2Na-H]+` ion) with confidence **B-**.
- Reference MS2: `[M+H]+`: FT06197_F07.S0848, FT06197_F07.S0872,
  FT06197_F08.S0850, FT06198_F07.S0907; high confidence.
  `[M+K]+`: FT07164_F08.S0860, FT07164_F07.S0860; low confidence?
...
- Reference MS2: `[M+H]+`: FT01389_F08.S0723, FT01389_F08.S0735
  `[M+H-NH3]+`: FT01006_F07.S0716, FT01006_F07.S0752, FT01006_F08.S0724,
  FT01006_F08.S0763
...
Since some of the available extracted MS2 spectra are associated to ions
different from `[M+H]+` we also perform a neutral loss comparison against
reference spectra from HMDB and MassBank.

```{r mix04-serum-pos-gmp-ms2-hmdb_nl, echo = FALSE, fig.width = 5, fig.height = 5}
std_hmdb_nl <- hmdb_nl[hmdb_nl$compound_id == hmdb_id]
std_ms2_nl <- neutralLoss(std_ms2, nl_param)
sim <- plot_ms2_similarity_heatmap(std_ms2_nl, std_hmdb_nl, csp_nl)
```

```{r mix04-serum-pos-gmp-ms2-mbank_nl, echo = FALSE, fig.width = 5, fig.height = 5}
std_mbank_nl <- get_mbank(mbank, inchikey = unique(std_hmdb$inchikey), nl = TRUE)
std_ms2_nl <- neutralLoss(std_ms2, nl_param)
sim <- plot_ms2_similarity_heatmap(std_ms2_nl, std_mbank_nl, csp_nl)
```
...
- Reference MS2: `[M+H]+`: FT06614_F07.S0874, FT06614_F07.S0917,
  ...
  `[M+Na]+`: FT07166_F07.S0886, FT07166_F08.S0899, FT07166_F08.S0938;
  `[M+K]+`: FT07553_F07.S0888;
...
```{r mix04-serum-pos-leucine-ms2-hmdb_nl, echo = FALSE, fig.width = 5, fig.height = 5}
std_hmdb_nl <- hmdb_nl[hmdb_nl$compound_id == hmdb_id]
std_ms2_nl <- neutralLoss(std_ms2, nl_param)
sim <- plot_ms2_similarity_heatmap(std_ms2_nl, std_hmdb_nl, csp_nl)
```

```{r mix04-serum-pos-leucine-ms2-mbank_nl, echo = FALSE, fig.width = 5, fig.height = 5}
std_mbank_nl <- get_mbank(mbank, inchikey = unique(std_hmdb$inchikey), nl = TRUE)
std_ms2_nl <- neutralLoss(std_ms2, nl_param)
sim <- plot_ms2_similarity_heatmap(std_ms2_nl, std_mbank_nl, csp_nl)
```
...
- FT01079 (RT = 170.6, `[M+H]+`): confidence level **C**?
- Reference MS2: `[M+H]+`: FT01078_F07.S0546, FT01078_F08.S0580
  (, FT01079_F08.S0684?)
...
- FT00877 (RT = 47.6, `[M+H]+` ion): confidence level **A**.
- FT00563 (RT = 48.5, `[M+H-NH3]+` ion): confidence level **A-**.
- FT00565 (RT = 63.6, `[M+H-NH3]+` ion). The spectra match has similarity
  greater than 0.7 but the precursor m/z difference is not close to 0. Should
  we exclude this and FT00879 (RT = 63.8, `[M+H]+` ion) in the same feature
  group?
- Reference MS2: `[M+H]+`: FT00874_F08.S0171, FT00874_F07.S0164,
  FT00877_F08.S0171, FT00877_F07.S0164; high confidence.
  `[M+H-NH3]+`: FT00560_F07.S0116, FT00560_F08.S0148, FT00563_F07.S0116,
  FT00563_F07.S0193, FT00563_F07.S0243, FT00563_F08.S0148, FT00563_F08.S0211,
  FT00563_F08.S0264
...
No MS2 spectra available and EIC of the only assigned feature shows a very low
intensity signal.
...
```{r mix04-serum-pos-putrescine-ms2-mbank_nl, echo = FALSE, fig.width = 5, fig.height = 5}
std_mbank_nl <- get_mbank(mbank, inchikey = unique(std_hmdb$inchikey), nl = TRUE)
std_ms2_nl <- neutralLoss(std_ms2, nl_param)
sim <- plot_ms2_similarity_heatmap(std_ms2_nl, std_mbank_nl, csp_nl)
```
```{r mix04-serum-pos-putrescine-mbank_nl, echo = TRUE, fig.cap = "Mirror plots"}
tmp_sel <- plot_select_ms2(std_ms2_nl, std_mbank_nl, 0.4, ppm = csp_nl@ppm,
                               tolerance = csp_nl@tolerance)
```
...
- FT01719 (RT = 172.9, `[M+H-NH3]+` ion) with confidence level **C**.
- FT00343 (RT = 173.2, `[M+H]+` ion) with confidence level **C-**..
...
sim <- plot_ms2_similarity_heatmap(std_ms2, std_mbank, csp)
```
Since some of the the available extracted MS2 spectra are associated to ions
different from `[M-H]-` we also perform a neutral loss comparison against
reference spectra from HMDB and MassBank.

```{r mix04-serum-pos-pyridoxine-ms2-hmdb_nl, echo = FALSE, fig.width = 5, fig.height = 5}
std_hmdb_nl <- hmdb_nl[hmdb_nl$compound_id == hmdb_id]
std_ms2_nl <- neutralLoss(std_ms2, nl_param)
sim <- plot_ms2_similarity_heatmap(std_ms2_nl, std_hmdb_nl, csp_nl)
```

```{r mix04-serum-pos-pyridoxine-ms2-mbank_nl, echo = FALSE, fig.width = 5, fig.height = 5}
std_mbank_nl <- get_mbank(mbank, inchikey = unique(std_hmdb$inchikey), nl = TRUE)
std_ms2_nl <- neutralLoss(std_ms2, nl_param)
sim <- plot_ms2_similarity_heatmap(std_ms2_nl, std_mbank_nl, csp_nl)
```
```{r mix04-serum-pos-pyridoxine-mbank_nl, echo = TRUE, fig.cap = "Mirror plots"}
tmp_sel <- plot_select_ms2(std_ms2_nl, std_mbank_nl, 0.85, ppm = csp_nl@ppm,
                               tolerance = csp_nl@tolerance)
```
The new found matches involve only a single peak.
...
- FT02338 (RT = 120.2, `[M+Na]+` ion) with confidence level **A-**.
- FT01886 (RT = 102.1, `[M+H]+` ion) with confidence level **A**.
- FT01514 (RT = 103.5, `[M+H-H2O]+` ion) with confidence level **A-**.
- Reference MS2: `[M+H]+`: FT01885_F07.S0363, FT01885_F07.S0463,
  FT01885_F08.S0482, FT01886_F08.S0304, FT01886_F08.S0356, FT01886_F08.S0377,
  FT01886_F07.S0331, FT01886_F07.S0363; high confidence.
  `[M+H-H2O]+`: FT01514_F08.S0395, FT01514_F07.S0382; high confidence.
  `[M+K]+`: FT02635_F07.S0427, FT02635_F08.S0458, FT02635_F08.S0491; high confidence?
  `[M+H-H2O]+`: FT01510_F07.S0336, FT01510_F07.S0382, FT01510_F07.S0435, 
  FT01510_F08.S0490; high confidence.
...
```{r mix04-serum-pos-riboflavin-ms2-hmdb_nl, echo = FALSE, fig.width = 5, fig.height = 5}
std_hmdb_nl <- hmdb_nl[hmdb_nl$compound_id == hmdb_id]
std_ms2_nl <- neutralLoss(std_ms2, nl_param)
sim <- plot_ms2_similarity_heatmap(std_ms2_nl, std_hmdb_nl, csp_nl)
```

```{r mix04-serum-pos-riboflavin-ms2-mbank_nl, echo = FALSE, fig.width = 5, fig.height = 5}
std_mbank_nl <- get_mbank(mbank, inchikey = unique(std_hmdb$inchikey), nl = TRUE)
std_ms2_nl <- neutralLoss(std_ms2, nl_param)
sim <- plot_ms2_similarity_heatmap(std_ms2_nl, std_mbank_nl, csp_nl)
```

We observe new matches for spectra from FT06489 and FT08645.

```{r mix04-serum-pos-riboflavin-mbank_nl, echo = TRUE, fig.cap = "Mirror plots"}
tmp_sel <- plot_select_ms2(std_ms2_nl, std_mbank_nl, 0.6, ppm = csp_nl@ppm,
                               tolerance = csp_nl@tolerance)
```
...
- FT06961 (RT=174, `[M+H]+` ion) with confidence level **B**.
- FT06962 (RT=184.4, `[M+H]+` ion) with confidence level **C**.
- FT06958 (RT=145.6, `[M+H]+` ion) with confidence level **B**.
- FT06488 (RT=145.6, `[M+H-H2O]+` ion)  with confidence level **B-**.
- Reference MS2: `[M+H]+`: FT06961_F07.S0707, FT06961_F07.S0707,
  FT06961_F08.S0715, FT06962_F08.S0715, FT06958_F07.S0528, FT06958_F08.S0562,
  FT06958_F08.S0563.

Using neutral loss spectra comparison we also get the following?

- FT06489 (RT=63.2, `[M+H-H2O]+` ion) very high similarity score for the match
  but single peak spectra. EIC doesn't look very good.
- FT08645 (RT=144.3, `[M+2K-H]+` ion) with confidence level **C**?
- FT08645 (RT=144.3, `[M+H+Na]2+` ion) with confidence level **C-**?
- FT08645 (RT=144.3, `[M+K]+` ion) with confidence level **C-**?
...
- It seems like no reference spectra for `r std` is availble in both HMDB
  and MassBank.
...
No MS2 spectra available and multiple features for `[M-H]-`.
...
- FT3362 (RT = 213.2, `[M-H]-` ion) with confidence level **B**.
- FT3361 (RT = 252.5, `[M-H]-` ion) confidence level **B**.
- Reference MS2: `[M-H]-`: FT3362_F15.S0747, FT3362_F15.S0780, FT3362_F16.S0723,
  FT3362_F16.S0758, FT3361_F15.S0886
...
- FT3646 (RT = 231.4, `[M-H]-` ion) with confidence level **A**.
- Reference MS2: `[M-H]-`: FT3643_F16.S0756, FT3643_F16.S0773,
  FT3646_F15.S0792; high confidence.
...
- Reference MS2: FT0254_F15.S0519, FT0254_F16.S0427, FT0254_F16.S0517.
...
- No MS2 spectra available.
- FT0191 (RT = 105, `[M+Cl]-` ion) with confidence level **D**? But associated
  EIC does not look good.
...
- FT1288 (RT = 103.9, `[M+HCOO]-` ion) matches with high similarity score but
  the m/z difference from precursor is not close to 0.
- FT0678 (RT = 104.1, `[M-H]-` in the same feature group as FT1288.

- Reference MS2: `[M-H]-`: FT1288_F15.S0325, FT0685_F15.S0350, FT0685_F15.S0380
  FT0685_F16.S0268, FT0685_F16.S0301; high confidence.
