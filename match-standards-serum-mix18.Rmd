...
- todo:
| **FT02848** |  243  |   3.494   | 37.65 |    235    |  FG.003.001   | [M+H-H2O]+ |   0   |   12.37   |  10.81   |
| **FT03428** | 278.1 |   21.92   |  142  |    235    |  FG.005.001   |  [M+NH4]+  |   0   |   11.31   |  6.458   |
| **FT03876** |  299  |   21.26   | 172.5 |    235    |  FG.001.001   |   [M+K]+   |   0   |   11.2    |  8.961   |
| **FT03535** |  283  |   22.08   | 176.9 |    235    |  FG.001.001   |  [M+Na]+   |   0   |   11.24   |  10.12   |
| **FT00902** |  131  |   1.654   | 197.4 |    235    |  FG.002.001   |  [M+2H]2+  |   0   |   10.13   |  7.578   |
| **FT02849** |  243  |   4.096   | 210.8 |    235    |  FG.004.001   | [M+H-H2O]+ |   0   |   12.06   |  7.187   |
...
```{r mix18-serum-pos-2-Hydroxybutyric acid-ms2, echo = FALSE}
plot_spectra(std_ms2)
```
...
```{r mix18-serum-pos-2-Hydroxybutyric acid-ms2-hmdb, echo = FALSE, fig.width = 5, fig.height = 5}
...
```{r mix18-serum-pos-2-Hydroxybutyric acid-ms2-mbank, echo = FALSE, fig.width = 5, fig.height = 5}
...
```{r mix18-serum-pos-2-Hydroxybutyric acid-mirror-hmdb, echo = TRUE, fig.cap = "Mirror plots"}
std_ms2_sel <- plot_select_ms2(std_ms2, std_hmdb, 0.5, ppm = csp@ppm,
                               tolerance = csp@tolerance)
```

```{r mix18-serum-pos-2-Hydroxybutyric acid-mirror-mbank, echo = TRUE, fig.cap = "Mirror plots"}
...
- No MS2 spectra available.
- FYI: 2-Hydroxybutyric acid and Amethopterin are synonyms
...
- No MS2 reference spectra available in HMDB and MassBank.
- No MS2 spectra available.
- FYI: Fructose 6-Phosphate and Amethopterin are synonyms
- FT08081 (RT = 455.2, 1.585 ppm, `[M+H]+` ion) with confidence **A**
- FT08863 (RT = 499.1, 1.695 ppm, `[M+2Na-H]+` ion) with confidence **D**
- FT08464 (RT = 477.2, 0.931 ppm, `[M+Na]+` ion) with confidence **D**
- FT03045 (RT = 228.1, 0.1243 ppm, `[M+2H]2+` ion) with confidence **D**
...
|:----------:|:-----:|:---------:|:-----:|:---------:|:-------------:|:-------------:|:-----:|:---------:|:--------:|
| **FT1564** |  259  |   11.89   | 164.3 |    163    |  FG.001.001   |    [M+Cl]-    |   0   |   12.98   |  10.12   |
| **FT1195** | 223.1 |   16.97   | 164.4 |    163    |  FG.001.001   |    [M-H]-     |   0   |   15.31   |  10.39   |
| **FT1959** | 291.1 |   16.08   | 164.6 |    163    |  FG.001.001   | [M-H+HCOONa]- |   0   |   12.33   |  10.44   |
